...
def data_config(parser):
    ...
    parser.add_argument('--mkd_opt', type=int, default=0, 
...
def main():
    ...
    print(str(len(multi_task_train_data)))
    ...
    if os.path.exists(init_model):
        if encoder_type == EncoderModelType.BERT or \
            ...
            #config=config_class.from_pretrained(init_model)
            #model_class = AutoModel.from_pretrained(init_model, config=config)
            #config = state_dict['config']
    ...
    ############ATTENZIONE###############DA MODIFICARE QUANDO DEVO FARE PRETRAINING
    if args.resume and args.model_ckpt:
        print_message(logger, 'loading model from {}'.format(args.model_ckpt))
        #load_state_dict(torch.load(PATH))
        model.load(args.model_ckpt)
        #for par in model.network.parameters():
          #print(par)
          #
          #
        #for name, param in model.network.named_parameters():
          #if(name=='bert.pooler.dense.weight' or name=="bert.pooler.dense.bias" or name=="scoring_list.0.weight" or name=="scoring_list.0.bias" or name=="pooler.dense.weight" or name=="pooler.dense.bias"):
          #if( name=="scoring_list.0.weight" or name=="scoring_list.0.bias" or name=="pooler.dense.weight" or name=="pooler.dense.bias"):
             #param.data=torch.randn_like(param.data,requires_grad=True)
              #print(name)
               #param.data=torch.zeros_like(param.data)
          #else:
            #Faccio il freeze dei parametri per fare il fine tuning
            #param.requires_grad = False
          #if(name=='bert.embeddings.word_embeddings.weight' or name=='bert.embeddings.position_embeddings.weight' or name=='bert.embeddings.token_type_embeddings.weight' or name=='bert.embeddings.LayerNorm.weight' or name=='bert.embeddings.LayerNorm.bias'):
          #else:
             #param.requires_grad = False
          #if(name=="bert.encoder.layer.9.attention.self.query.bias" or name=="bert.encoder.layer.9.attention.self.query.bias" or name=="bert.encoder.layer.9.attention.self.key.weight" or name=="bert.encoder.layer.9.attention.self.key.bias" or name=="bert.encoder.layer.9.attention.self.value.weight" or name=="bert.encoder.layer.9.attention.self.value.bias" or name=="bert.encoder.layer.9.attention.output.dense.weight" or name==" bert.encoder.layer.9.attention.output.dense.bias" or name=="bert.encoder.layer.9.attention.output.LayerNorm.weight"
          #or name=="bert.encoder.layer.9.attention.output.LayerNorm.bias" or name=="bert.encoder.layer.9.intermediate.dense.weight" or name=="bert.encoder.layer.9.intermediate.dense.bias"
          #or name=="bert.encoder.layer.9.output.dense.weight" or name=="bert.encoder.layer.9.output.dense.bias" or name=="bert.encoder.layer.9.output.LayerNorm.weight" or name=="bert.encoder.layer.9.output.LayerNorm.bias"
          #or name=="bert.encoder.layer.10.attention.self.query.bias" or name=="bert.encoder.layer.10.attention.self.query.bias" or name=="bert.encoder.layer.10.attention.self.key.weight" or name=="bert.encoder.layer.10.attention.self.key.bias" or name=="bert.encoder.layer.10.attention.self.value.weight" or name=="bert.encoder.layer.10.attention.self.value.bias" or name=="bert.encoder.layer.10.attention.output.dense.weight" or name==" bert.encoder.layer.10.attention.output.dense.bias" or name=="bert.encoder.layer.10.attention.output.LayerNorm.weight"
          #or name=="bert.encoder.layer.10.attention.output.LayerNorm.bias" or name=="bert.encoder.layer.10.intermediate.dense.weight" or name=="bert.encoder.layer.10.intermediate.dense.bias"
         # or name=="bert.encoder.layer.10.output.dense.weight" or name=="bert.encoder.layer.10.output.dense.bias" or name=="bert.encoder.layer.10.output.LayerNorm.weight" or name=="bert.encoder.layer.10.output.LayerNorm.bias"
          #or name=="bert.encoder.layer.11.attention.self.query.bias" or name=="bert.encoder.layer.11.attention.self.query.bias" or name=="bert.encoder.layer.11.attention.self.key.weight" or name=="bert.encoder.layer.11.attention.self.key.bias" or name=="bert.encoder.layer.11.attention.self.value.weight" or name=="bert.encoder.layer.11.attention.self.value.bias" or name=="bert.encoder.layer.11.attention.output.dense.weight" or name==" bert.encoder.layer.11.attention.output.dense.bias" or name=="bert.encoder.layer.11.attention.output.LayerNorm.weight"
          #or name=="bert.encoder.layer.11.attention.output.LayerNorm.bias" or name=="bert.encoder.layer.11.intermediate.dense.weight" or name=="bert.encoder.layer.11.intermediate.dense.bias"
          #or name=="bert.encoder.layer.11.output.dense.weight" or name=="bert.encoder.layer.11.output.dense.bias" or name=="bert.encoder.layer.11.output.LayerNorm.weight" or name=="bert.encoder.layer.11.output.LayerNorm.bias"
          #or name=="bert.pooler.dense.weight" or name=="bert.pooler.dense.bias"):
    ...
    #tokenizer = AutoTokenizer.from_pretrained("mt_dnn_models/RobertaVoc/RobertaVoc2")
    #sentence_a = "@CHEMICAL$ inhibitors currently under investigation include the small molecules @GENE$ "
    #sentence_b = "@CHEMICAL$ inhibitors currently under investigation include the small molecules @GENE$ "
    #inputs = tokenizer.encode_plus(sentence_a, sentence_b, return_tensors='pt', add_special_tokens=True)
    #input_ids = inputs['input_ids']
    #attention = model.network(input_ids)[-1]
    ...
    for epoch in range(0, args.epochs):
        ...
        for i, (batch_meta, batch_data) in enumerate(multi_task_train_data):
            ...
            #HO modificato non testando ad ogni epoca
