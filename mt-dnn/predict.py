...
###################
parser.add_argument("--model_checkpoint", default='mt_dnn_models/bert_model_base_uncased.pt', type=str)
...
###########
#MI serve quando devo fare distillazione da un modello più grande
load_model_ckpt(model.network, model_checkpoint)
#######
model.cuda()
...
with torch.no_grad():
    test_metrics, test_predictions, scores, golds, test_ids = eval_model(model, test_data,
                                                                         metric_meta=metric_meta,task_type=1,
                                                                         device=cuda0,#with_label=args.with_label
                                                                          )
